module HSChewy
  module Search
    ...
    class QueryProxy
      ...
      # @param request [HSChewy::Search::Request] request instance for modification
      ...
      #   Executes {HSChewy::Search::Parameters::QueryStorage#must} in the scope
      #   of newly created request object.
      #
      #   @see HSChewy::Search::Parameters::QueryStorage#must
      ...
      #   Executes {HSChewy::Search::Parameters::QueryStorage#should} in the scope
      #   of newly created request object.
      #
      #   @see HSChewy::Search::Parameters::QueryStorage#should
      #   @return [HSChewy::Search::Request]
      #
      ...
      #   Executes {HSChewy::Search::Parameters::QueryStorage#must_not} in the scope
      #   of newly created request object.
      #
      #   @see HSChewy::Search::Parameters::QueryStorage#must_not
      #   @return [HSChewy::Search::Request]
      #
      ...
      #   Executes {HSChewy::Search::Parameters::QueryStorage#and} in the scope
      #   of newly created request object.
      #
      #   @see HSChewy::Search::Parameters::QueryStorage#and
      #   @return [HSChewy::Search::Request]
      #
      ...
      #       # => <PlacesIndex::Query {..., :body=>{:query=>{:bool=>{
      #       #      :must=>[{:bool=>{:must_not=>{:match=>{:name=>"Moscow"}}}}, {:match=>{:name=>"London"}}]}}}}>
      #     @param scope [HSChewy::Search::Request] other scope
      #
      #   @overload and
      #     If block is passed instead of a pure hash, `elasticsearch-dsl"
      #     gem will be used to process it.
      ...
      #   Executes {HSChewy::Search::Parameters::QueryStorage#or} in the scope
      #   of newly created request object.
      #
      #   @see HSChewy::Search::Parameters::QueryStorage#or
      #   @return [HSChewy::Search::Request]
      #
      ...
      #   Executes {HSChewy::Search::Parameters::QueryStorage#not} in the scope
      #   of newly created request object.
      #   The only difference from {#must_not} is that is accepts another scope additionally.
      #
      #   @see HSChewy::Search::Parameters::QueryStorage#not
      #   @return [HSChewy::Search::Request]
      #
      ...
      %i[and or not].each do |method|
        define_method method do |query_hash_or_scope = nil, &block|
          ...
          query_hash_or_scope = query_hash_or_scope.parameters[@parameter_name].value if !block && query_hash_or_scope.is_a?(HSChewy::Search::Request)
          @request.send(:modify, @parameter_name) { send(method, block || query_hash_or_scope) }
        end
      end

      # Executes {HSChewy::Search::Parameters::QueryStorage#minimum_should_match} in the scope
      # of newly created request object.
      #
      # @see HSChewy::Search::Parameters::QueryStorage#minimum_should_match
